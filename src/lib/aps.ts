// ============================================================
// APS (Admission Point Score) calculation logic
// SA standard 7-point scale — migrated from vanilla JS
// ============================================================

import type { MarkRange } from './constants';

/** Convert a percentage to a 7-point APS value */
...
/** Get midpoint percentage for a mark range string */
...
/** Compute APS from subject marks map. Returns total (best 6), best6 rows, allRows. */
...
/** CSS class for APS score colouring */
...
/** CSS class for individual APS point values */
...
/**
 * SBA cushion: given an SBA mark, what exam % is needed to reach a target overall?
 * Formula: 0.25 * sba + 0.75 * exam = target  →  exam = (target - 0.25*sba) / 0.75
 */
